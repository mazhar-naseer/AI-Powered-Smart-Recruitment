...
import{AdminLogin,Landing,VerifyEmail}from'./pages/Public';
import{ForgotPassword,ResetPassword}from'./pages/Password';
import{Login,Register}from'./pages/SocialAuth';
...
import{AdminCommercial,WorkspaceCommercial}from'./pages/SaaS';
...
export default function App(){return <Routes>
  <Route path="/" element={<PublicOnly><Landing/></PublicOnly>}/><Route path="/login" element={<PublicOnly><Login/></PublicOnly>}/><Route path="/forgot-password" element={<PublicOnly><ForgotPassword/></PublicOnly>}/><Route path="/reset-password" element={<PublicOnly><ResetPassword/></PublicOnly>}/><Route path="/admin/setup" element={<PublicOnly><AdminSetup/></PublicOnly>}/><Route path="/admin/login" element={<PublicOnly><AdminLogin/></PublicOnly>}/><Route path="/register" element={<PublicOnly><Register/></PublicOnly>}/><Route path="/verify-email" element={<PublicOnly><VerifyEmail/></PublicOnly>}/><Route path="/oauth/callback" element={<OAuthCallback/>}/><Route path="/home" element={<Home/>}/>
  ...
  <Route path="/employer/settings" element={<Protected roles={['employer']}><WorkspaceCommercial/></Protected>}/>
  ...
  <Route path="/admin/saas/requests" element={<AdminProtected><PlanRequests/></AdminProtected>}/>
  <Route path="/admin/saas" element={<AdminProtected><AdminCommercial/></AdminProtected>}/>
  <Route path="/admin/governance" element={<AdminProtected><AdminGovernance/></AdminProtected>}/>
